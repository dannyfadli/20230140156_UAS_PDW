    ...
    <aside class="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-grow">
            <ul class="space-y-2 p-4">
                ...
                <li>
                    <a href="pratikum.php" class="<?= ($activePage == 'praktikum') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M4 6h16M4 12h16M4 18h16" /></svg>
                        <span>Manajemen Praktikum</span>
                    </a>
                </li>
                <li>
                    <a href="akun_pengguna.php" class="<?= ($activePage == 'akun') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M5.121 17.804A9.003 9.003 0 0112 15c2.21 0 4.21.803 5.879 2.138M15 10a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
